...
| 2 | Issue トリアージボット | `tutorial issue-triage` | 予定 | `DefineTool`、型付きツール I/O、ツール呼び出しエージェント |
| 3 | ストリーミングレビュー | `tutorial streaming-review` | 予定 | ストリーミングデルタ、リアルタイム出力 |
| 4 | スキルによるドキュメント生成 | `tutorial skills-docgen` | 予定 | `SkillDirectories`、`SKILL.md`、ドキュメント生成 |
| 5 | 監査ログ | `tutorial audit-hooks` | 予定 | セッションフック、パーミッションハンドラ、監査ログ |
| 6 | BYOK Azure OpenAI | `tutorial byok-azure-openai` | 予定 | `ProviderConfig`、Azure OpenAI API キー＆Entra ID |
