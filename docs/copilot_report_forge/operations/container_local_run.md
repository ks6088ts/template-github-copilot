...
> **Note:** The Docker images use Copilot CLI version `1.0.63` (pinned in compose files and Dockerfiles). To update, change `COPILOT_CLI_VERSION` in the compose files and Dockerfiles.
