...
> Last reviewed on **2026-06-29** against `github/copilot-cli` changelog version **1.0.65 (2026-06-24)** and GitHub Blog Changelog entries through **2026-06-29**. See [References](appendix/references.md#change-watchlist) for the sources to monitor before running the workshop.
