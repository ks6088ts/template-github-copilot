...
> 最終確認日は **2026-06-29** で、`github/copilot-cli` changelog の **1.0.65（2026-06-24）** と、**2026-06-29** までの GitHub Blog Changelog に基づいています。ワークショップ実施前に確認すべき情報源は [References](appendix/references.md#change-watchlist) を参照してください。
